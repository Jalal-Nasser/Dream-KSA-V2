/**
 * app/src/db/mic.ts - static shim to avoid dynamic require usage (Metro invalid call)
 * Re-exports canonical implementation from project-root src/db/mic if present.
 * If not present, exports safe no-op stubs so bundling succeeds.
 *
...
try {
  ...
  console.warn('[app/src/db/mic shim] ../../src/db/mic not found. Using fallback stubs.', e && e.message);
